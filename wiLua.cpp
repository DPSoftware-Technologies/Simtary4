...
namespace wi::lua
{
	...
	void FixedUpdate()
	{
		SignalHelper(lua_internal().m_luaState, "Simtary_fixed_update_tick");
	}
	void Update()
	{
		SignalHelper(lua_internal().m_luaState, "Simtary_update_tick");
	}
	void Render()
	{
		SignalHelper(lua_internal().m_luaState, "Simtary_render_tick");
	}
