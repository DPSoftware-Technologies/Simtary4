...
namespace wi
{
	...
	void RenderPath3D_PathTracing::Update(float dt)
	{
		...
		if (sam == target)
		{
			...
			{
				//wi::helper::saveTextureToFile(denoiserAlbedo, "C:/PROJECTS/Simtary/Editor/_albedo.png");
				//wi::helper::saveTextureToFile(denoiserNormal, "C:/PROJECTS/Simtary/Editor/_normal.png");
